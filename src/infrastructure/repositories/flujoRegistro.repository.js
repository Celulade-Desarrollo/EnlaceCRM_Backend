...
.input("Fecha_Envio_Formulario", sql.DateTime, new Date())
  ...
  async actualizarRegistro(id, input) {
    ...
    await pool.request()
      .input("id", sql.Int, id)
      .input("Estado", sql.NVarChar(100), input.Estado ?? null)
      .input("Numero_de_Cliente_Alpina", sql.NVarChar(100), input.Numero_de_Cliente_Alpina)
      .input("Cedula_Cliente", sql.NVarChar(100), input.Cedula_Cliente)
      .input("Correo_Electronico", sql.NVarChar(100), input.Correo_Electronico)
      .input("Nombres", sql.NVarChar(100), input.Nombres ?? null)
      .input("Primer_Apellido", sql.NVarChar(100), input.Primer_Apellido)
      .input("SegundoApellido", sql.NVarChar(100), input["2do_Apellido_opcional"])
      .input("Genero", sql.NVarChar(100), input.Genero)
      .input("Estado_Civil", sql.NVarChar(100), input.Estado_Civil)
      .input("Fecha_de_Nacimiento", sql.NVarChar(100), input.Fecha_de_Nacimiento)
      .input("Pais_de_Nacimiento", sql.NVarChar(100), input.Pais_de_Nacimiento)
      .input("Departamento_de_Nacimiento", sql.NVarChar(100), input.Departamento_de_Nacimiento)
      .input("Nivel_Educativo", sql.NVarChar(100), input.Nivel_Educativo)
      .input("Estrato", sql.NVarChar(100), input.Estrato)
      .input("Grupo_Etnico", sql.NVarChar(100), input.Grupo_Etnico)
      .input("Declara_Renta", sql.Bit, input.Declara_Renta)
      .input("Esta_obligado_a_tener_RUT", sql.Bit, input.Esta_obligado_a_tener_RUT_por_tu_actividad_economica)
      .input("Ubicacion_del_Negocio_Departamento", sql.NVarChar(100), input.Ubicacion_del_Negocio_Departamento)
      .input("Ubicacion_del_Negocio_Ciudad", sql.NVarChar(100), input.Ubicacion_del_Negocio_Ciudad)
      .input("Direccion", sql.NVarChar(100), input.Direccion)
      .input("Detalles", sql.NVarChar(100), input.Detalles)
      ...
      .input("Declaracion_de_nacionalidad_y_residencia_fiscal_en_Colombia", sql.Bit, input.Declaracion_de_nacionalidad_y_residencia_fiscal_en_Colombia)
      .input("Confirmacion_Identidad", sql.Bit, input.Confirmacion_Identidad)
      .input("Cedula_Conyuge", sql.NVarChar(100), input.Cedula_Conyuge || "No aplica")
      .input("Nombre_Conyuge", sql.NVarChar(100), input.Nombre_Conyuge || "No aplica")
      .input("Apellido_Conyuge", sql.NVarChar(100), input.Apellido_Conyuge || "No aplica")
      .input("Valor_Bienes", sql.NVarChar(100), input.Valor_Bienes)
      .input("Valor_Deudas", sql.NVarChar(100), input.Valor_Deudas)
      .input("Gastos_Mensuales", sql.NVarChar(100), input.Gastos_Mensuales)
      .input("Deuda_Mensual", sql.NVarChar(100), input.Deuda_Mensual)
      .input("Ingresos_Diferentes_Negocio", sql.NVarChar(100), input.Ingresos_Diferentes_Negocio)
      .input("nbCliente", sql.VarChar(100), input.nbCliente)
      .input("nbAgenteComercial", sql.VarChar(100), input.nbAgenteComercial)
      .input("Monto_ingresos_diferentes_negocio", sql.NVarChar(100), 
      ...
      .input("Monto_Mensual_Deuda", sql.NVarChar(100), 
      ...
      .input("Municipio_nacimiento", sql.NVarChar(100), input.Municipio_nacimiento)
      .input("Lugar_expedicion", sql.NVarChar(100), input.Lugar_expedicion)
      .input("Fecha_expedicion", sql.NVarChar(100), input.Fecha_expedicion)
      ...
      .input("ComprasPromedioAlpinaUltTrim", sql.NVarChar(100), input.ComprasPromedioAlpinaUltTrim)  
      .query(`
