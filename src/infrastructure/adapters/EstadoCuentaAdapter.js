...
export class EstadoCuentaAdapter extends EstadoCuentaPort {
  ...
  async registrarMovimientoAbono(IdMovimiento, AbonoUsuario, Intereses, Fees){
    return await estadoCuentaRepository.registrarMovimientoAbono(IdMovimiento, AbonoUsuario, Intereses, Fees);
  }
  ...
  async consultarRecaudoTransportistaPorFecha(){
    return await estadoCuentaRepository.consultarRecaudoTransportistaPorFecha();
  }
}
