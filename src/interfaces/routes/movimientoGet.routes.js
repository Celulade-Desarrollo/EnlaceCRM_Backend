...
import { getMovimientosByCliente } from "../controllers/movimientoGet.Controller.js";
 ...
 *                     format: date-time
 */
movimientoRouter.get("/api/movimientos/:clienteId",authMiddleware, getMovimientosByCliente);
