...
export async function setStatusProcessUseCase(process_id) {
    ...
    const declinedReasons = {
        ...
        missing_security_elements:"Faltan elementos de seguridad",
        ...
        liveness_verification_not_passed:"No se pudo comprobar que es una persona real",
        passive_liveness_verification_not_passed:"Verificación de presencia física no superada",
        "fraudster_face_match_*" :"",
        face_in_blocklist:"Rostro en lista de bloqueo",  
        risky_face_detected:"Se ha detectado un rostro de riesgo",
        user_face_match_in_client_collection:"Validación de rostro en la base de datos del cliente",
        ...
        ocr_failed:"Error de OCR",
        ocr_no_text_detected:"No se detectó texto en el OCR",
        ...
        canceled:"Cancelado",	
        not_used:"No usado",
        unwanted_camera_permissions:"Permisos de cámara denegados",
        no_document_media_uploaded: "No se ha subido ningún documento multimedia",
        "no_*_validation_not_started":"Validación no iniciada",
