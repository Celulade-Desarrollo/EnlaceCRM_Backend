...
export async function getExcelData() {
    ...
    const PORCENTAJE_COSTO = 0.1666666666;
    
     const excelFullData = excelDataArray.map(excelData => {

        const rangoIngresos = excelData.Rango_de_Ingresos
            ? Number(excelData.Rango_de_Ingresos.toString().replace(/\./g, ""))
            : 0;
        ...
        return {
            ...
            Nombre_Tienda: excelData.Nombre_Tienda,
            ...
            Costo_Mercancia_Vendida: new Intl.NumberFormat('es-CO').format(
